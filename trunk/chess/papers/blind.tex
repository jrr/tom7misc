...
capture,\footnotemark\ so it suffices to store the $75*2$ most recent
...
square, a straightforward representation of the board uses $64*4=256$
...
%
With the 9 bits of extra state above, this totals $64+32*4+9=201$
...
This totals a nice round $64+32*4=192$ bits.\footnote{ Since this is
...
So this is kind of like blindfold chess ... XXX
