...
field. This book~\cite{o1997thomas} actually does have 94 citations
(or DOES IT?) on Google Scholar and an Amazon Sales Rank of \#10,837
...
The first is definitely a real article~\cite{bedient1974eight}---which
