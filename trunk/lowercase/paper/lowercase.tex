...
\section{The simplest thing that might work}
...
% XXX total number of parameters?
...
three hidden layers of size 308, 308, 360. The first two layers are
dense and the third sparse (about half of the weights are zero). All
layers are leaky rectified linear units. If you're taking notes,
don't, as again this does not work well, and I don't know how people
figure out what the right network size is anyway. I just made it up.
You can give {\em me} your notes.
...
% TODO: Screenshot of this thing's output.
