...
% 12 times for titled players, although there are a few things that
% are even rarer, like dying on a8.
...
(only XXX), so the variance is somewhat higher. % XXX give error bounds?
