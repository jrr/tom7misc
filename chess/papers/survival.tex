...
in the popular Queen's Gambit (1. d4 d5 2. c4); this may be a good
example of a piece that has very different survival rates in different
opening preferences. Since the variance is otherwise very low, I did
not attempt to 
...
piece to the death, and possessing some influence over the 
...
listed right there and they are in order. In each map, the background
color gives the 
...
\chessmap{piece3}{\Queen}
\chessmap{piece4}{\King}
...
\chessmap{piece27}{\queen}
\chessmap{piece28}{\king}
