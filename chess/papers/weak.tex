...
\describeplayer{dangerous} The dual of \player{safe}; the score is
...
\describeplayer{fatalist} The dual of \player{fatalist}; the score is
...
\describeplayer{worstfish} (compare ``losing chess'')
...
\describeplayer{chessmaster.nes\_lv2} \deterministic
