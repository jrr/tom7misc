...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.9 \linewidth]{connected}
  \caption{

  } \label{fig:connected}
  \end{figure}

% autotracing in here, I think?

% screenshot UI where I can draw letters and get live
% predictions? Just for the video perhaps? I like the "cool s" joke?
